...
function ClientsFeedback() {
    ...
    return (
        <div className=" bg-customNoiseWhite w-screen" id="testimonials">
            <div className="w-[800px] bg-customNoiseWhite flex flex-col mt-10 h-[620px] pt-20 gap-16 m-auto">
                ...
                <div className="grid grid-cols-3">
                    {
                        datas.map(data => (
                            <ClientsFeedbackCard key={data.id} name={data.name} comment={data.comment} photoPath={data.photoPath} />
                        ))
                    }
