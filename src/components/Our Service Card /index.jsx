...
function OurServiceCard({logo}) {
    return (
        <div className="flex flex-col text-center items-center gap-3">
            ...
            {(logo === "wordpress" && <FaWordpressSimple size={"24px"} color="white"/>) || 
            (logo === "shoppingcard" && <FaShoppingCart size={"24px"} color="white"/>) ||
            (logo === "cloud" && <FaCloudDownloadAlt size={"24px"} color="white" />) || 
            (logo === "translate" && <MdGTranslate size={"24px"} color="white"/>) ||
            ...
            <p className="text-[10px] font-extralight text-white ">
